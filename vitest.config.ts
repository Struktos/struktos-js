// ============================================================================
// Struktos.js ADaaS Platform - Vitest Root Configuration
// ============================================================================
//
// 🎯 Purpose:
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@struktos/core': path.resolve(__dirname, './packages/core/src'),
      '@struktos/sknul': path.resolve(__dirname, './packages/sknul/src'),
      '@struktos/cli': path.resolve(__dirname, './packages/cli/src'),
      '@struktos/architecture': path.resolve(__dirname, './packages/architecture/src'),
      '@struktos/resilience': path.resolve(__dirname, './packages/resilience/src'),
      '@struktos/shared': path.resolve(__dirname, './packages/shared/src'),
    },
  },
});
